...
const BgSlider = () => {
    ...
    const [sliderPosition,getSliderPosition]=useState(40)
    const handleSliderChange=(e)=>{
        setSliderPosition(e.target.value)
    }
  return (
    <div className='pb-10 md:py-20 mx-2'>
        <h1 className=' md-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold  bg-gradient-to-r from-gray-900 to-gray-40 bg-clip-text text-transparent'>Remove Background with high <br /> Quality and Accuracy</h1>
