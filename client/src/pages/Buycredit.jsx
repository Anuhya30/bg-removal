  ...
  return (
    <div className='min-h-[80vh] text-center pt-14 mb-10'>
      <button className='border border-gray-400 px-10 py-2 rounded-full mb-6'>Our plan</button> 
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold  bg-gradient-to-r from-gray-900 to-gray-40 bg-clip-text text-transparent mb-6 sm:mb-10'>Steps to remove background <br /> image  in seconds</h1>
      <h1 className=''>Choose the plan that's right for you </h1> 
